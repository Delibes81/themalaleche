    ...
    return (
        ...
        >
            ...
            <main className="max-w-4xl mx-auto px-6 py-12 md:py-20 relative z-10">
                <Link href="/" className="inline-flex items-center gap-2 text-sm uppercase tracking-wider font-light text-gray-500 hover:text-gray-900 transition-colors mb-12">
